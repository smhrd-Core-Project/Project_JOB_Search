...
<head>
    ...
    <style>
        ...
        #searchLoadingModal.flex { display: flex; }
        /* From Uiverse.io by Nawsome: 햄스터 애니메이션 */
...
<body>
 ...
 <!-- 로딩 모달 -->
  <div id="searchLoadingModal">
    <div role="img" aria-label="햄스터 러닝 애니메이션" class="wheel-and-hamster">
      <div class="wheel"></div>
      <div class="hamster">
